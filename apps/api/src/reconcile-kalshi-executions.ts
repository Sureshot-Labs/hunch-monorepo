...
export async function runReconcileKalshiExecutions(
  ...
  console.log(
    [
      ...
      `sponsorshipChecked=${summary.sponsorshipChecked}`,
      `sponsorshipConfirmed=${summary.sponsorshipConfirmed}`,
      `sponsorshipSkipped=${summary.sponsorshipSkipped}`,
      `sponsorshipErrors=${summary.sponsorshipErrors}`,
      `sponsorshipRentReclaimChecked=${summary.sponsorshipRentReclaimChecked}`,
      `sponsorshipRentReclaimClosed=${summary.sponsorshipRentReclaimClosed}`,
