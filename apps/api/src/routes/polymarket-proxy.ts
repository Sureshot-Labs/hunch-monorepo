...
export const polymarketProxyRoutes: FastifyPluginAsync = async (app) => {
   ...
   */
  z.get("/price-history/status", async (_request, reply) => {
    const status = {
  ...
  z.get(
    "/price-history",
    { schema: { querystring: priceHistoryQuerySchema } },
    async (request, reply) => {
  ...
  z.post(
    "/orderbook/batch",
    { schema: { body: orderbookBatchBodySchema } },
    async (request, reply) => {
  ...
  z.get(
    "/price/:tokenId",
    { schema: { params: tokenIdParamsSchema, querystring: priceQuerySchema } },
    async (request, reply) => {
      const { tokenId } = request.params;
  ...
  z.post(
    "/price/batch",
    { schema: { body: priceBatchBodySchema } },
    async (request, reply) => {
      const body = request.body;
