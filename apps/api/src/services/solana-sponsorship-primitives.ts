...
export const SOLANA_DFLOW_SPONSORSHIP_ALLOWED_PROGRAMS = [
  ...SOLANA_BASE_SPONSORSHIP_ALLOWED_PROGRAMS,
  DFLOW_PROGRAM_ID,
  DFLOW_PREDICTION_PROGRAM_ID,
] as const;

export const SOLANA_ACROSS_SPONSORSHIP_ALLOWED_PROGRAMS = [
  ...SOLANA_BASE_SPONSORSHIP_ALLOWED_PROGRAMS,
  ACROSS_SOLANA_SPOKE_POOL_PROGRAM_ID,
] as const;

export const SOLANA_DIRECT_TRANSFER_SPONSORSHIP_ALLOWED_PROGRAMS = [
  SOLANA_COMPUTE_BUDGET_PROGRAM_ID,
  SOLANA_TOKEN_PROGRAM_ID,
  SOLANA_TOKEN_2022_PROGRAM_ID,
  SOLANA_MEMO_PROGRAM_ID,
...
export const SOLANA_DEBRIDGE_BASE_SPONSORSHIP_ALLOWED_PROGRAMS = [
  ...SOLANA_BASE_SPONSORSHIP_ALLOWED_PROGRAMS,
] as const;
