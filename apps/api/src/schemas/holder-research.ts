...
export function buildHolderResearchSystemPrompt(): string {
  return [
    ...
    "PUBLISH means the holder data adds a useful, timely, feed-worthy directional read for users. It does not need to be unexplained by public news.",
  ...
  return JSON.stringify(
    {
      ...
      style_rules: [
        ...
        "PUBLISH should be a directional holder-backed signal; disagreement or risk-only reads are CONTEXT unless they clearly support one side.",
