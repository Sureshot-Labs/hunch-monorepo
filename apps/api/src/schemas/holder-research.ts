...
export function buildHolderResearchSystemPrompt(): string {
  return [
    ...
    'Good story example: "Mentionmarket has kept the full position despite heavier tracked money betting against France. The wallet traded $1.2M over the last 30 days and is still holding one of the largest tracked positions in the market."',
    ...
    'Good story example: "The price of NO fell by 11¢ to 61¢, meaning the market has become more confident that Bitcoin could reach $67.5K. The tracked wallet still holds $5.8K on NO, but the market has moved against its position since the signal."',
