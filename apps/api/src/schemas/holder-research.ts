...
export function buildHolderResearchSystemPrompt(): string {
  return [
    ...
    "Prefer SKIP when the evidence is weak, stale, whale-dominated without a useful caveat, or already obvious from odds alone.",
  ...
  return JSON.stringify(
    {
      ...
      style_rules: [
        ...
        "If the signal is only mildly interesting, choose CONTEXT or SKIP and say why briefly.",
      ],
