...
export function buildHolderResearchSystemPrompt(): string {
  return [
    ...
    'Good headline examples: "Strong wallets are fading Norway", "Strong wallets back France to cover", "Smart money is against the favorite", "A strong wallet is still holding Spain", "Team Atlas still has a believer after the dip".',
