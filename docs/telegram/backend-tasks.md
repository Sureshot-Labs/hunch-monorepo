...
- Signal Post V7 numeric-hook grammar, meaningful-delta research updates,
...
| P0       | [Signal Post V7 rollout](backend-signal-post-copy-v4.md)                      | Run test-channel/device QA for the locally complete contract path, then make a separate rollout decision | New contract-ready Holder Research note                       |
...
1. Produce one new contract-ready Holder Research note and validate exact V7
   text/keyboard through `/test_signal` in a test channel.
2. Complete V7 device QA. Production rollout remains a separate explicit
...
- Signal Post V7 is a renderer/prompt/test change and adds no migration; its
